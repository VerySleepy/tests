...
call ..\..\scripts\clear_config
call ..\..\scripts\set_config %CONFIG_SYMPATH% "!SYMDIR!"
call :RUN_PROFILER
...
call ..\..\scripts\get_config %CONFIG_SYMPATH% PRE_RUN_SYMPATH
call :RUN_PROFILER "/symsearchpath:!EMPTY_SYMDIR!"
call ..\..\scripts\get_config %CONFIG_SYMPATH% POST_RUN_SYMPATH
...
call ..\..\scripts\clear_config
call ..\..\scripts\set_config %CONFIG_SYMCACHE% "!SYMCACHE!"
call :RUN_PROFILER
if !SYMBOL_FOUND! neq 1 (echo ERROR: failed scenario 7a) & exit /b 1
rem    Test the override
@echo scenario 7b: symbol not found
call :CLEAR_DIR "!EMPTY_SYMCACHE!"
call ..\..\scripts\get_config %CONFIG_SYMCACHE% PRE_RUN_SYMCACHE
call :RUN_PROFILER "/symcachedir:!EMPTY_SYMCACHE!"
call ..\..\scripts\get_config %CONFIG_SYMCACHE% POST_RUN_SYMCACHE
...
:CLEAR_DIR
if exist "%SYMCACHEDIR%" rmdir /s /q "%SYMCACHEDIR%"
mkdir "%SYMCACHEDIR%"
exit /B
...
call ..\..\scripts\sleepy!pgmarch! /r:program!pgmarch!.exe /o:program-!pgmarch!.sleepy !ADDL_ARGS!
if !ERRORLEVEL! neq 0 exit /b 1

rem  Check for the target symbol.
call ..\..\scripts\test_symbol program-!pgmarch! vs_test_fun
@ECHO !ERRORLEVEL!
